...
function gridListViewSwitcher() {
    if(jQuery(window).width() < 800) {
	    jQuery('.switch_grid').trigger('click');
	    jQuery('.view').removeClass('listview');
	    jQuery('.view').addClass('gridview');
    }
    ...
    jQuery(window).resize(function() {
        if(jQuery(window).width() < 800) {
            ...
            jQuery('.switch_list').trigger('click');
            jQuery('.view').removeClass('gridview');
            jQuery('.view').addClass('listview');
        }
    });
...
jQuery('.switch_grid').ready(function() {
    gridListViewSwitcher();
});

jQuery('.view').ready(function() {
    gridListViewSwitcher();
});
