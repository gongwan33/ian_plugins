...
class SpiderWechatPipeline(object):
    ...
    def from_settings(cls, settings):
        ...
        cursor.execute("""TRUNCATE TABLE wechat_data""")
    ...
    def process_item(self, item, spider):
        ...
        try:
            self.cursor.execute("""INSERT INTO wechat_data (title, store, category, coupon_code, expire_date, img, dst_url, tags, post_data) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)""", (
